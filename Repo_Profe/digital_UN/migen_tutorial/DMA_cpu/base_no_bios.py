...
class BaseSoC(SoCCore):
    def __init__(self, platform, **kwargs):
        ...
        SoCCore.__init__(self, platform,
            ...
            integrated_rom_init      = "no_bios_firmware/firmware.bin"

        )
        # "little" for the default RISCV architectures selected by litex
        #self.add_rom("bootrom", 0x20000000, 2**10, contents=get_mem_data("firmware.bin", endianness="little"))  
...
#        ))
        ...
        analyzer_signals = [
            ...
            self.adc0.reset_ad,
            self.adc0.dout#,
            #self.adc0.rstrb_storage#,
            #self.adc0.spi_tx_data
