module peripheral_spi_M(clk , reset , d_in , cs , addr , rd , wr, d_out , perip_clk_spi , perip_cs_spi, perip_SO);
  ...
  output wire perip_clk_spi ;
  output wire perip_cs_spi ;
